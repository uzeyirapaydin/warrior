...
public:
	...
	bool ImportMD2(t3DModelMd2 *pModel, char *strFileName, char *strTexture);
...
//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////
	...
	void ParseAnimations(t3DModelMd2 *pModel);

//////////// *** NEW *** ////////// *** NEW *** ///////////// *** NEW *** ////////////////////


	// This converts the member variables to our pModel structure
	void ConvertDataStructures(t3DModelMd2 *pModel);
